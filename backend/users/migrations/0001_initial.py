...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, upload_to='profile_pics', verbose_name='Profile image')),
                ...
                ('new_notification', models.PositiveIntegerField(default=0, null=True, verbose_name='Number of new notifications')),
